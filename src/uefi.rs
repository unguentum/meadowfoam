...
type GOPQueryMode = extern "efiapi" fn(
...
type GOPSetMode =
    extern "efiapi" fn(this: *mut GraphicsOutputProtocol, mode_number: u32) -> StatusCode;
type GOPBlt = extern "efiapi" fn(
    this: *mut GraphicsOutputProtocol,
    blt_buffer: *const GOPBltPixel,
